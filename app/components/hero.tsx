...
export default function Hero () {
    ...
    return(
        <div className="w-full flex overflow-clip font-light flex-col md:justify-between md:flex-row max-w-screen md:h-screen px-6 md:pt-24 pt-20 md:px-20">
            <motion.div 
            initial={{
            ...
            className="md:w-[400px] flex flex-col justify-between w-full">
                ...
                <p className="text-justify md:pr-10 text-[14px] md:text-[12px] mt-32 md:mt-10 md:pt-0 md:pb-20">
            ...
            <div className="md:w-[400px] w-full md:pt-0 justify-between flex flex-col md:items-end">
                ...
                className="flex w-full md:flex-col py-5  font-light">
                    <div>
                        ...
                        <span className="md:text-[36px] text-[28px] font-medium">20-22</span>th 2024
                    </div>
                    </div>
                    <div className="flex flex-col md:w-full w-3/5 justify-self-end items-end text-end md:items-end pt-2">
                        <div className="font-semibold md:text-base text-[14px]">Kampus Mesen UNS</div>
                        <div className="md:text-[11px] text-[10px] md:text-end md:w-[240px]">Jl. Jend. Urip Sumoharjo No.112, Purwodiningratan, Kec. Jebres, Kota Surakarta, Jawa Tengah 57129</div>
                    </div>
                </motion.div>
                <motion.div 
                initial={{
                ...
                className="md:pb-20 flex flex-col mt-20 md:mt-0 w-full md:w-[300px] md:justify-end md:items-end justify-center items-center">
                    ...
                    <div className="w-full py-2 md:py-0 flex md:flex-col md:items-end items-center md:gap-0 gap-4 md:justify-between justify-evenly">
                        <div className="font-medium md:font-light md:px-8 px-3 md:py-2 md:my-3 py-1 text-[15px] md:text-[20px] w-fit flex justify-center items-center bg-white/30 rounded-lg text-breakWhite border-breakWhite border-[1px] backdrop-blur-sm">
                            {countdown}
                        </div>
                        <Link href="/catalogue" className="px-2 md:px-0 flex group md:justify-between justify-center md:items-start items-center h-fit md:h-20 md:w-4/5 rounded-lg bg-breakWhite text-black">
                            ...
                            <GoArrowRight className="text-[40px] md:text-[56px] md:self-end font-light flex items-center justify-end md:justify-center rotate-45 group-hover:rotate-0 group-hover:text-lightRed duration-300 ease-in-out"/>
                        </Link>
                    </div>
                </motion.div>
            </div>
